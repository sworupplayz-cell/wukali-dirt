...
export const PROP_TYPES = [
  ...
  { name: 'bridge', build: bridgeDeck, max: 28 },
  ...
  { name: 'busstop', build: busstop, max: 24 },
  { name: 'fuel', build: fuelStation, max: 14 },
  { name: 'pole', build: utilityPole, max: 120 },
  ...
  { name: 'roadseg', build: roadSegment, max: 180 },
  { name: 'roadsign', build: roadSign, max: 64 },
  { name: 'parklot', build: parkingLot, max: 28 },
  ...
  { name: 'fence', build: fence, max: 170 },
  ...
  { name: 'houseN', build: houseN, max: 96 },
  { name: 'townhouseN', build: townhouseN, max: 96 },
  { name: 'cityAN', build: cityAN, max: 40 },
  { name: 'cityBN', build: cityBN, max: 44 },
  { name: 'shopN', build: shopN, max: 56 },
  ...
  { name: 'poleN', build: poleN, max: 130 },
